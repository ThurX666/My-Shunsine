//don't delete credits and don't for sale this script.
//donate for me : paypal.me/ricoendico
//                https://sociabuzz.com/sebastiann/tribe
//Youtube       : https://www.youtube.com/c/RicoEndico
        ...
        if(newkeys & KEY_LOOK_RIGHT && !IsPlayerInAnyVehicle(playerid))
 		{
			...
			else if(flashlight==2)
			{
			    RemovePlayerAttachedObject(playerid,1);
				RemovePlayerAttachedObject(playerid,2);
				SetPlayerAttachedObject(playerid, 1,18656, 6, 0.16, -0.0155, 0.16, 86.5, -185, 86.5, 0.03, 0.1, 0.03);
				SetPlayerAttachedObject(playerid, 2,18641, 6, 0.2, 0.01, 0.16, 90, -95, 90, 1, 1, 1);
				flashlight=2;
				return 1;
			}
