...
stock GenerateRandomPlate() {
	...
	format(string, 32, "%d%s%s%s%d%d", random(9), PlatePossible[rand[0]], PlatePossible[rand[1]], PlatePossible[rand[2]], random(9), random(9));
...
stock GenerateRandomVIP() {
	...
	format(string, 52, "AV%d%s%s%s%d%d%d", random(9), PlatePossible[rand[0]], PlatePossible[rand[1]], PlatePossible[rand[2]], random(9), random(9), random(9));
...
stock experieddate( timestamp, _form=0 )
{
    ...
    */
    ...
    switch( _form ){
        ...
        case 2: format(returnstring, 500, ""WHITE_E"["ORANGE_E"Expired"WHITE_E"]", day+1, month+1, year);
        case 3: format(returnstring, 500, "%02d/%02d/%d", day+1, month+1, year);
...
{
	if(pData[playerid][pRadioStream] != 0)
		return 0;
