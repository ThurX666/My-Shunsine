...
//Varivale Others
new Text:AnimTD;
new PlayerText:AnimInfo[MAX_PLAYERS];
...
{
    //Anim Td
	AnimInfo[playerid] = CreatePlayerTextDraw(playerid, 231.000000, 378.000000, "~w~PRESS~r~ SPACE ~w~TO STOP ANIMATION");
	PlayerTextDrawFont(playerid, AnimInfo[playerid], 1);
	PlayerTextDrawLetterSize(playerid, AnimInfo[playerid], 0.183333, 1.400000);
	PlayerTextDrawTextSize(playerid, AnimInfo[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, AnimInfo[playerid], 1);
	PlayerTextDrawSetShadow(playerid, AnimInfo[playerid], 0);
	PlayerTextDrawAlignment(playerid, AnimInfo[playerid], 1);
	PlayerTextDrawColor(playerid, AnimInfo[playerid], -1);
	PlayerTextDrawBackgroundColor(playerid, AnimInfo[playerid], 255);
	PlayerTextDrawBoxColor(playerid, AnimInfo[playerid], 50);
	PlayerTextDrawUseBox(playerid, AnimInfo[playerid], 0);
	PlayerTextDrawSetProportional(playerid, AnimInfo[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, AnimInfo[playerid], 0);
	//Info textdraw
